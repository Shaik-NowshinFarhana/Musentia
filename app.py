...
with col2:
    st.image("Images/logo.png", width=530)
...
st.write(
"Musentia is an emotion detection based music recommendation system. "
"To get recommended songs, allow camera access for this web app."
)
